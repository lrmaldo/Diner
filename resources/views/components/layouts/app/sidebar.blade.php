            ...
            <nav class="flex-1 space-y-1 px-2 py-4">
                ...
                <div x-data="{ open: {{ request()->routeIs('consultas.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" class="space-y-1 pl-10" x-cloak>
                        ...
                        @role('Administrador')
                        <a href="{{ route('consultas.reportes-control') }}"
                           class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('consultas.reportes-control') ? 'bg-blue-100 text-blue-900 dark:bg-blue-900 dark:text-blue-100' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white' }}"
                           wire:navigate>
                            Reportes de control
                        </a>
                        @endrole
                ...
                <a href="{{ route('roles.index') }}"
                   class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('roles.*') ? 'bg-blue-100 text-blue-900 dark:bg-blue-900 dark:text-blue-100' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white' }}"
                   wire:navigate>
                    <svg class="mr-3 h-5 w-5 {{ request()->routeIs('roles.*') ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 10-8 0v2"></path>
                    </svg>
                    Roles y Permisos
                </a>
                @endcan
